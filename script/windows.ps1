...
#>
param(
  [string]$MsiUrl = "https://downloads.puppetlabs.com/windows/puppet/puppet-agent-x64-latest.msi"
  ,[string]$PuppetVersion = $null
)

if ($PuppetVersion -ne $null) {
  $MsiUrl = "https://downloads.puppetlabs.com/windows/puppet/puppet-$($PuppetVersion)-x64.msi"
